...
export declare const FoldersApiFp: {
    ...
    foldersGet(): (fetch: FetchAPI, basePath?: string) => Promise<ResFolder[]>;
    foldersIdDelete(params: {
        id: number;
    }): (fetch: FetchAPI, basePath?: string) => Promise<ResFolder[]>;
    foldersIdGet(params: {
...
export declare class FoldersApi extends BaseAPI {
    /**
     * copy sourcefolder in to target folder
     * 将源目录拷贝到目标目录下
    ...
    /**
     * move sourcefolder in to target folder
     * 将源目录移动到目标目录下
     * @param sourceFolderId sourceFolderId
     * @param targetFolderId targetFolderId
     */
